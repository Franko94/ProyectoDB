...
public class AuditoriaRW {
    ...
    public static final String FILTRAR_AUDITORIA = "SELECT * FROM auditoria_y_eventos where fecha = ? OR `usuario solicitante` = ? OR descripcion = ? OR `usuario afectado` = ? OR `rol afectado` = ?";
